        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center shrink-0">
              <span className="text-[#c8102e] font-bold text-sm">NS</span>
            </div>
            <div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sticky top-24">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button 
                ...
                className={`w-full bg-[#c8102e] text-white font-bold py-3 rounded-lg transition shadow-md ${isSubmitting ? 'opacity-70 cursor-not-allowed' : 'hover:bg-red-700 hover:shadow-lg'}`}
              >
                {isSubmitting ? 'Đang lưu...' : 'Đăng tin tuyển dụng'}
              </button>
            </form>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              {jobs.length === 0 ? (
                ...
                jobs.map((job) => (
                  <div key={job.id} className="border border-gray-200 rounded-xl p-5 hover:border-gray-300 transition group relative">
                    <button 
